...
const Activity = () => {
    ...
    return (
        <div className=" h-full p-2 border-l-2  border-slate-300 shadow-md">
            ...
            {completedIdeas.map((idea) => (
                <div
                    key={idea.key}
                    className="flex justify-between items-center py-3 px-3 w-full bg-slate-50 border-b-2 border-slate-300 mb-4 rounded-md shadow-sm"
                >
